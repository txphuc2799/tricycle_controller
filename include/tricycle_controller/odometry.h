#ifndef TRICYCLE_CONTROLLER__ODOMETRY_H_
#define TRICYCLE_CONTROLLER__ODOMETRY_H_
...
public:
     ...
     * \param traction_pos Traction wheel position [rad]
     * \param steer_pos    Steer position [rad]
     * \param time         Current time
     * \return true if the odometry is actually updated
     */
    bool update(double traction_pos, double steer_pos, const ros::Time& time);
...
#endif // TRICYCLE_CONTROLLER__ODOMETRY_H_
